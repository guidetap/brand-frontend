  ...
  <div className="py-16 bg-gray-50 overflow-hidden lg:py-24">
    <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
      ...
      <div className="relative">
        ...
        <div className="md:mt-20 sm:mt-15">
          <div className="mt-1 relative rounded-md shadow-sm sm:max-w-sm md:max-w-md">
            ...
            <input id="company_website" className="form-input block pl-16 w-full sm:pl-14 sm:text-sm sm:leading-5" placeholder="mystore.shopify.com" />
